    ...
    post: {
      ...
      buildVariables: (request) => {
        ...
        return {
          ...
          tone,
          strategy,
          generation_intent: variables.generationIntent ?? variables.generation_intent,
          creator_content_type: variables.creatorContentType ?? variables.creator_content_type,
          creator_visual_style: variables.creatorVisualStyle ?? variables.creator_visual_style,
