      ...
      <template v-else>
        <section class="workspace-card planner-autopilot-card">
          <div class="planner-autopilot-header">
            <div>
              <p class="workspace-eyebrow">Automation Studio</p>
              <h2>Run campaign orchestration in a dedicated surface.</h2>
            </div>
            <p class="workspace-description compact">
              Keep Planner focused on calendar operations. Use Automation Studio for goal-driven AI workflow execution and campaign batch generation.
            </p>
          </div>
          <div class="planner-sidebar-actions">
            <router-link class="workspace-primary-button" :to="appRoutes.appAutomationStudio">
              Open Automation Studio
            </router-link>
            <p class="planner-inline-tip">
              Mission setup, sequential generation pipeline, and day-by-day campaign packs now live in Automation Studio.
            </p>
          </div>
        </section>
